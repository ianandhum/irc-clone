...
Zomoji.prototype.replace = function( text ) {
    return ( typeof text === "string" ) ? DOMPurify.sanitize(text, {USE_PROFILES: { html: false, mathMl: false, svg: false }}).replace( this.smiley_regex, this._replacer.bind( this ) ) : text;
};
